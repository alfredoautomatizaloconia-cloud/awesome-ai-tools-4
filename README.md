...
- [TinyTools](https://tinytools-smoky.vercel.app/) - Free browser-based AI utilities: AI background remover (runs locally via WebAssembly, no upload), OG image generator, favicon generator, color palette generator, AI cost calculator, AI content disclosure generator (EU AI Act compliant), AI robots.txt generator, and SEO meta tag generator. No signup, open source. [Free]
